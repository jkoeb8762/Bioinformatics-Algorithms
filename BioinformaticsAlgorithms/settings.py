"""
Django settings for BioinformaticsAlgorithms project.
...
ROOT_URLCONF = 'BioinformaticsAlgorithms.urls'
...
WSGI_APPLICATION = 'BioinformaticsAlgorithms.wsgi.application'
